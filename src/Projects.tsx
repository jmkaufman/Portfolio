...
import {
  PersonalProject,
  PersonalProjectsDataModel,
} from "./PersonalProjectsModels";

function Projects(): JSX.Element {
  // State variable.
  const [personalProjectsData, setPersonalProjectsData] =
    useState<PersonalProjectsDataModel>();
    ...
    <div className="projects">
      ...
      <div className="project-block-layout">
        {!personalProjectsData
          ? "Loading..."
          : createProjectBlocks(personalProjectsData.personalProjects)}
      </div>
    </div>
  );
}
